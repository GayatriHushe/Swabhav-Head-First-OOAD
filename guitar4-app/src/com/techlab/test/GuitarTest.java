...
public class GuitarTest {
	...
	public static void main(String[] args) {
		...
		inventory.addGuitar("1", 500.0, Builder.FENDER, "Stratocastor", Type.ELECTRIC, Wood.ALDER, Wood.ALDER,6);
		inventory.addGuitar("2", 600.0, Builder.FENDER, "Stratocastor", Type.ELECTRIC, Wood.ALDER, Wood.ALDER,6);
		...
		if (!matchingGuitars.isEmpty()) {
			...
			for (Iterator i = matchingGuitars.iterator(); i.hasNext(); ) {
				...
				System.out.println(" We have a " + 	spec.getBuilder() + " " + 
						spec.getModel() + " " +spec.getNumStrings()+" - string "+ spec.getType() + " guitar:\n " +
